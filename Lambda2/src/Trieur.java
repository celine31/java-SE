...
public class Trieur<E> {
    ...
    static public class ComparateurLivre implements Comparateur<Livre> {//inner-class qui doit être static
    ...
    public static void main(String[] args) {
        ...
        Trieur.trier(liste, new ComparateurLivre());//on peut faire un new d'une classe statique ici 
        System.out.println(liste);
    }
}
